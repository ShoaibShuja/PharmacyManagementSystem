...
export function DashboardView({ role }: { role: AppRole }) {
  ...
  return (
    <div className="relative isolate space-y-6 overflow-hidden rounded-[1.75rem] bg-[radial-gradient(circle_at_top_right,oklch(0.93_0.055_163_/_0.72),transparent_28rem)] p-1 dark:bg-[radial-gradient(circle_at_top_right,oklch(0.32_0.085_163_/_0.42),transparent_28rem)] sm:p-2">
      <div className="relative space-y-6 rounded-[1.45rem] bg-background/80 p-3 sm:p-4">
        <div className="rounded-2xl border border-primary/15 bg-card px-5 py-5 shadow-[0_14px_38px_-28px_oklch(0.25_0.08_165_/_0.52)] sm:px-6">
          <PageHeader
        ...
        {!isCashier ? (
          ...
          <Card className="border-primary/15 bg-card shadow-[0_14px_38px_-30px_oklch(0.25_0.08_165_/_0.5)]">
...
function MetricCard({
  ...
  return (
    <Card
      className={cn(
        "group relative overflow-hidden border-border/80 bg-card transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-[0_18px_36px_-28px_oklch(0.25_0.08_165_/_0.65)]",
        tone === "primary" && "border-primary/20 bg-[linear-gradient(135deg,oklch(0.98_0.018_164),oklch(1_0_0))] dark:bg-[linear-gradient(135deg,oklch(0.25_0.052_164),oklch(0.205_0.022_252))]",
        tone === "warning" && "border-amber-200/90 bg-[linear-gradient(135deg,oklch(0.985_0.025_85),oklch(1_0_0))] dark:border-amber-500/30 dark:bg-[linear-gradient(135deg,oklch(0.27_0.045_85),oklch(0.205_0.022_252))]",
        tone === "danger" && "border-red-200/90 bg-[linear-gradient(135deg,oklch(0.985_0.018_25),oklch(1_0_0))] dark:border-red-500/30 dark:bg-[linear-gradient(135deg,oklch(0.25_0.045_25),oklch(0.205_0.022_252))]",
      )}
    >
      <CardContent className="relative p-5">
        <div
          className={cn(
            "absolute inset-x-0 top-0 h-1 bg-border",
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div
            className={cn(
            "grid size-10 place-items-center rounded-xl bg-muted text-muted-foreground ring-1 ring-inset ring-border/70",
              tone === "primary" && "bg-accent text-primary ring-primary/10",
...
function NotificationPanel({
  ...
  return (
    <Card
      className={cn(
        "overflow-hidden shadow-[0_14px_32px_-28px_oklch(0.25_0.08_165_/_0.55)]",
        total > 0
          ? "border-amber-200 bg-[linear-gradient(100deg,oklch(0.985_0.025_85),oklch(1_0_0))] dark:border-amber-500/30 dark:bg-[linear-gradient(100deg,oklch(0.27_0.045_85),oklch(0.205_0.022_252))]"
          : "border-emerald-200 bg-[linear-gradient(100deg,oklch(0.98_0.02_165),oklch(1_0_0))] dark:border-emerald-500/30 dark:bg-[linear-gradient(100deg,oklch(0.25_0.045_165),oklch(0.205_0.022_252))]",
      )}
    >
...
function SectionCard({
  ...
  return (
    <Card className="overflow-hidden border-border/80 bg-card shadow-[0_14px_34px_-30px_oklch(0.25_0.08_165_/_0.62)]">
      <div className="flex flex-col gap-3 border-b border-border/70 bg-muted/25 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <TableBody>
              {alerts.slice(0, 6).map((alert) => (
                <TableRow key={alert.medicineId}>
                  <TableCell>
                    <Link href="/medicines" className="font-medium transition-colors hover:text-primary">
                      {alert.brandName}
                    </Link>
                    {alert.genericName ? (
                  ...
                  <TableCell className="text-right">
                    <Badge className="border-amber-200 bg-amber-50 text-amber-800 hover:bg-amber-50 dark:border-amber-500/30 dark:bg-amber-500/15 dark:text-amber-200 dark:hover:bg-amber-500/15">
...
function CompactEmptyState({
  ...
  return (
    <div className="flex min-h-52 flex-col items-center justify-center rounded-xl border border-dashed border-border/90 bg-muted/20 p-6 text-center">
